...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		zoomShit = FlxG.camera.initialZoom;
	...
	function startIntro()
	{
		...
		titleBg.frames = Paths.getSparrowAtlas('door');
		titleBg.antialiasing = ClientPrefs.globalAntialiasing;
		titleBg.animation.addByPrefix('bump', 'doorIdle0', 24, false);
		titleBg.animation.addByPrefix('open', 'doorOpen0', 24, false);
		titleBg.animation.play('bump');
		...
		logoBl = new FlxSprite(FlxG.width / 2.6, -10);
		logoBl.frames = Paths.getSparrowAtlas('modLogo');
		logoBl.antialiasing = ClientPrefs.globalAntialiasing;
		logoBl.animation.addByPrefix('bump', 'modLogo0', 24, false);
	...
	override function beatHit()
	{
		...
		if (!closedState)
		{
			switch (curBeat)
			{
				...
				// credTextShit.text += '\nVs.';
				case 15:
					addMoreText('The Tavern'); // credTextShit.text += '\nThe Tavern';
				case 16:
