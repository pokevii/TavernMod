...
{
	public static var psychEngineVersion:String = '0.4.2pp'; //This is also used for Discord RPC
	public static var tavernModVersion:String = '1.0.1';
	...
	override function create()
	{
		...
		for (i in 0...optionShit.length)
		{
			...
			var menuItem:FlxSprite = new FlxSprite(0, (i * 104) + 40);
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Tavern Mod v" + tavernModVersion, 12);
