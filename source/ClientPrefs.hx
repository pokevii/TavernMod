...
class ClientPrefs {
	...
	public static var resetAchievements:Bool = false;
	public static var freebie:Bool = false;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.resetAchievements != null) {
			resetAchievements = FlxG.save.data.resetAchievements;
		}

		if(FlxG.save.data.freebie != null) {
			freebie = FlxG.save.data.freebie;
		}
