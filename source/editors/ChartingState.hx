...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Change Character', "Value 1: Character to change (0 = BF, 1 = Dad, 2 = GF)\nValue 2: New character's name"],
		['TGB Lightning Flash', "For Rain's song."],
		['Toggle Spotlight', "For stadium stage charts.\nValue 1: 0 = Turn on, 1 = Turn off\nValue 2: 0 = No sound, 1 = Play sound"]
	];
